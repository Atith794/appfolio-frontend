...
export default async function AppManagePage({ 
  ...
  return (
    <main style={{ padding: 12 }}>
      {/* App Hero panel */}
      <h2 className="text-black text-xl font-black tracking-tight font-serif">App Hero</h2>
        <AppHeroPanel appId={appId} />
      <hr className="border-t-3 border-dotted border-primary/50 my-8" />

      {/* App overview panel */}
      <h2 className="text-black text-xl font-black tracking-tight font-serif">App Overview</h2>
