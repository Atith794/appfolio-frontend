...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL || "https://appshelves.com"
  ),
  title: "AppShelves | Mobile App Portfolio Builder for Developers",
  description:
    "AppShelves helps mobile app developers create professional app portfolios with screenshots, flows, architecture, tech stack, decisions, and shareable project pages.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: "AppShelves | Mobile App Portfolio Builder for Developers",
    description:
      "Create a professional mobile app portfolio with screenshots, flows, architecture, tech stack, and shareable project pages.",
    url: "/",
    siteName: "AppShelves",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AppShelves mobile app portfolio builder",
      },
    ],
  },
  twitter: {
    ...
    title: "AppShelves | Mobile App Portfolio Builder for Developers",
    description:
      "Build a professional portfolio page for your mobile apps, APKs, screenshots, flows, and tech stack.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
...
function WebsiteJsonLd() {
  const jsonLd = {
    ...
    description:
      "AppShelves helps mobile app developers create professional app portfolios with screenshots, flows, architecture, tech stack, decisions, and shareable project pages.",
    url: process.env.NEXT_PUBLIC_SITE_URL || "https://appshelves.com",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
    ...
    <>
      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col">
        <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-charcoal/80 backdrop-blur-xl px-6 md:px-12 py-4">
          <div className="relative flex items-center justify-center md:justify-between max-w-[1440px] mx-auto">
            {" "}
            ...
            <div className="hidden md:flex flex-1 justify-end gap-8 items-center">
              <nav className="flex items-center gap-8">
                <SignedIn>
                  <button className="flex items-center justify-center rounded-lg h-10 px-6 text-primary text-sm font-bold hover:bg-primary hover:text-white transition-all font-serif cursor-pointer">
              ...
              <div className="flex gap-4">
                <SignedOut>
                  <SignInButton mode="modal">
                    <button className="flex items-center justify-center rounded-lg h-10 px-6 text-violet-600 text-sm font-bold transition-all hover:bg-primary hover:text-white cursor-pointer font-serif">
                      Sign In
                    </button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button className="flex items-center justify-center rounded-lg h-10 px-6 bg-primary text-white text-sm font-bold shadow-lg shadow-primary/20 hover:bg-white/20 hover:text-primary transition-all cursor-pointer font-serif">
                      Register
                    </button>
                  </SignUpButton>
                </SignedOut>
                <SignedIn>
                  <button className="flex items-center justify-center rounded-lg h-10 px-6 bg-primary text-white text-sm font-bold shadow-lg shadow-primary/20 hover:bg-white/20 hover:text-primary transition-all font-serif cursor-pointer">
        ...
        <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="flex flex-col gap-8 text-left relative z-10">
                ...
                <h1 className="text-black text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight">
                  Showcase your mobile app <br />
                  <span className="text-primary">like a real product.</span>
                </h1>
                ...
                <p className="text-gray-400 text-base sm:text-lg md:text-xl font-medium leading-relaxed max-w-[540px]">
                  {/* AppShelves helps mobile app developers present their mobile apps
                  with screens, flows, architecture, and decisions — all in one
                  professional, shareable page. */}
                  AppShelves helps Android, iOS, React Native, and Flutter or any other mobile developers create professional mobile app portfolios with screenshots, user flows, architecture, tech stack, decisions, and shareable project pages.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <SignedOut>
                    <SignUpButton mode="modal">
                      <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-primary text-white text-sm sm:text-base md:text-lg font-bold shadow-2xl shadow-primary/30 hover:scale-[1.02] transition-all">
                        Create your AppShelves app portfolio
                      </button>
                    </SignUpButton>
                  </SignedOut>
                  <SignedIn>
          ...
          <section className="bg-charcoal px-6 md:px-12 lg:px-20 pt-24 border-y border-white/5">
            <div>
              <h2 className="text-black text-3xl md:text-5xl lg:text-7xl font-black leading-tight tracking-tight font-mono">
                Your app deserves more than just{" "}
                <span className="text-primary">screenshots and repos</span>
              </h2>
            </div>
            <div className="max-w-[1440px] mx-auto">
              ...
              <h2 className="text-primary text-3xl md:text-4xl font-black leading-tight tracking-tight font-serif">
                What AppShelves Does?
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 py-10">
                <div className="group bg-slatePanel rounded-xl overflow-hidden border border-white/5 flex flex-col hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="p-5 flex flex-col gap-1">
                    <p className="text-black text-base font-bold font-serif">
                      Helps you build a professional app-portfolio
                    </p>
                ...
                <div className="group bg-slatePanel rounded-xl overflow-hidden border border-white/5 flex flex-col hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="p-5 flex flex-col gap-1">
                    <p className="text-black text-base font-bold font-serif">
                      Turns your app into a product case study
                    </p>
                    <p className="text-gray-500 text-xs font-mono">
                      Perfect for pitching your app
                    </p>
                  </div>
                </div>
                <div className="group bg-slatePanel rounded-xl overflow-hidden border border-white/5 flex flex-col hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="p-5 flex flex-col gap-1">
                    <p className="text-black text-base font-bold font-serif">
                      Helps create shareable links to share your app-craft
                    </p>
                    <p className="text-gray-500 text-xs font-mono">
                      Best platform to showcase your apps among your network
                    </p>
                  </div>
                </div>
                <div className="group bg-slatePanel rounded-xl overflow-hidden border border-white/5 flex flex-col hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="p-5 flex flex-col gap-1">
                    <p className="text-black text-base font-bold font-serif">
                      Group screens by onboarding, features, and edge cases
                    </p>
                    <p className="text-gray-500 text-xs font-mono">
                      Crafted for app developers
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8">
              <div className="col-span-2 flex flex-col gap-6">
                ...
                <p className="text-gray-500 text-sm leading-relaxed max-w-[320px] font-mono">
                  Empowering creatives to showcase their unique stories and land
                  life-changing opportunities through beautiful design.
                </p>
              </div>
              <div className="flex flex-col gap-5">
                <h4 className="text-black font-bold text-sm font-serif">
                  Product
                </h4>
            ...
            {/* <div className="mt-20 pt-8 border-t border-white/5 text-gray-600 text-[10px] flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="font-serif">
                © 2026 AppShelves Inc. All rights reserved.
              </p>
            </div> */}
          </div>
        </footer>
